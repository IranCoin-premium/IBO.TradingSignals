...
import tabsRouter from './modules/tabs/tabs.routes';
...
// SEO & METADATA APIS
// REFERRAL & SALES PARTNERSHIP APIS (Part 12 — server-authoritative)
app.use(`${prefix}/referral`, referralRouter);

// PLATFORM TAB REGISTRY (readiness manifest for AI Studio client tabs)
app.use(`${prefix}/tabs`, tabsRouter);
